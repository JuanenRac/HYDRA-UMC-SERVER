...
│   └── verify_*_contract.mjs, verify_auth_negative.mjs  # 19 real contract/negative-auth checks run
...
│                           in-process, no server spawned, complementing the end-to-end tools/ checks above
